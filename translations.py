...
# =========================================================
# ОБЩИ ПРЕВОДИ ЗА КЛИЕНТСКАТА ЧАСТ
# =========================================================
...
TRANSLATIONS = {
    "bg": {
        ...
        "request_success": (
            "Заявката е успешно изпратена до рецепцията."
        ),

        # SPA
        "spa_page_title": "SPA",
        "relaxing_massage": "Релаксиращ масаж",
        "relaxing_massage_description": (
            "Професионален масаж на цялото тяло."
        ),
        "spa_instruction": (
            "Моля, посочете деня и часа, за които желаете "
            "да направите резервация."
        ),
        "spa_placeholder": (
            "Пример: Искам масаж на 22.09.2026 г. в 16:00 ч."
        ),
        "spa_success_service": "💆 Услуга: Релаксиращ масаж",
        "spa_success_contact": (
            "🛎️ Рецепцията ще се свърже с Вас за потвърждение."
        ),
        ...
        "activity_instruction": (
            "Моля, посочете желания ден и добавете "
            "необходимата информация за резервацията."
        ),
        "example_message": "Примерно съобщение:",
        "ski_example": (
            "Желая да резервирам ски оборудване "
            "за 22.09.2026 г."
        ),
        "activity_reception_message": (
            "Рецепцията ще се свърже с Вас за уточняване "
            "и потвърждение на резервацията."
        ),

        # Room Service
        "room_service_menu": "Room Service меню",
        "breakfast": "Закуска",
        ...
        "order_success": (
            "Поръчката е успешно изпратена до рецепцията."
        ),
    ...
    "en": {
        ...
        "request_success": (
            "Your request has been successfully sent to reception."
        ),
        ...
        "spa_instruction": (
            "Please specify the preferred date and time "
            "for the reservation."
        ),
        "spa_placeholder": (
            "Example: I would like a massage on "
            "September 22, 2026 at 4:00 PM."
        ),
        "spa_success_service": "💆 Service: Relaxing massage",
        "spa_success_contact": (
            "🛎️ Reception will contact you for confirmation."
        ),
        ...
        "activity_instruction": (
            "Please enter the preferred date and add "
            "the necessary reservation details."
        ),
        "example_message": "Example message:",
        "ski_example": (
            "I would like to reserve ski equipment "
            "for September 22, 2026."
        ),
        "activity_reception_message": (
            "Reception will contact you to finalize "
